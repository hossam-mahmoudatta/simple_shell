...
/* fileIO_Functions.c Functions*/
char *get_charHistoryFile(info_t *);
int write_intHistory(info_t *);
int read_intHistory(info_t *);
int build_intHistoryList(info_t *, char *, int);
int reNumber_intHistory(info_t *);
